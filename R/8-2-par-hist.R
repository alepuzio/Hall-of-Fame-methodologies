#8-2-par-hist
par(mfrow=c(1,3))
hist(raw.data.interesting$KANBAN, col = "red", main = "KANBAN", xlab = "VOLUME", ylim = c(0, 40))
hist(raw.data.interesting$SCRUM, col = "green", main = "SCRUM", xlab = "VOLUME", ylim = c(0, 40))
hist(raw.data.interesting$NOESTIMATES, col = "blue", main = "NOESTIMATES", xlab = "VOLUME", ylim = c(0, 40))
